...
This repository includes small, redistributable SQLite databases to make demos and smoke tests self-contained.

## Included databases
- `demo.db`: Minimal demo database used by `make demo`.
